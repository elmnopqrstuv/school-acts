...
const setupProductDetailListeners = () => {
    ...
    ctaButton.addEventListener('click', (e) => {
        ...
        if (typeof addToCart === 'function') {
            // Capture the current main product image (whether original or from thumbnail)
            const currentImageSrc = mainProductImage.src;
            
            const product = {
                id: currentProduct.id,
                name: currentProduct.name,
                price: currentPrice,
                image: currentImageSrc || currentProduct.image,
